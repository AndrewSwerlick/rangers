...
\begin{tikzpicture}[x=1in, y=-1in, every node/.style={text=black}]
  ...
  \locationcard{0}{0}%
    {THE CAMPGROUND}%
    {Civilian Recruits}%
    {The civilians here step up to defend their home. Breach rolls at this location are made with one extra die.}%
    {It's a Trap!}%
...
\begin{tikzpicture}[x=1in, y=-1in, every node/.style={text=black}]
  ...
  \locationcard{0}{0}%
    {THE FORTRESS}%
    {Fortified Location}%
    {These walls were built to last. Breach defense rolls at this location get +1 to the result.}%
    {Hunker Down}%
  ...
  \locationcard{3.75}{0}%
    {THE RANGER STATION}%
    {Coordinated Defense}%
    {The comms equipment lets you direct the defense. As an action, pick two locations or manned obstacles. The next breach roll at each is made with an extra die.}%
    {Triage}%
